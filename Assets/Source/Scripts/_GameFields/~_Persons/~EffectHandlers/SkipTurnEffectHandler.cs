...
{
    public class SkipTurnEffectHandler : EffectHandler, IEffectHandlerActiveWatcher, ILengthyEffectHandler
    {
        private readonly List<Card> _effectedCards;

        public SkipTurnEffectHandler(FightProcessDBManager fightProcessDBManager, bool isPlayersObject) : base(fightProcessDBManager, isPlayersObject)
        {

...
{
    public class DoubleEffectHandler: EffectHandler, ILengthyEffectHandler
    {
        private readonly List<Card> _effectedCards;

        public DoubleEffectHandler(FightProcessDBManager fightProcessDBManager, bool isPlayersObject) : base(fightProcessDBManager, isPlayersObject)
        {

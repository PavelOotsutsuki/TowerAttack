...
{
    public class StartMenuSettingsButtonsPanel : StartMenuButtonsPanel, IAutomaticFillComponents
    {
        ...
        [ContextMenu(nameof(DefineAllComponents) + nameof(StartMenuSettingsButtonsPanel))]
